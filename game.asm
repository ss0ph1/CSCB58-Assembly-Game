...
.eqv FLOOR_COLOR 0xDEB887   # color of the floor
.eqv FLOOR_HEIGHT 15
...
jump_height: .word 12
platform_x: .word 0, 31, 0, 18, 12  # platfrom's x position
platform_y: .word 18, 25, 32, 40, 8 # platform's y position
platform_len: .word 24, 8, 25, 15, 15

platform_x_l2: .word 25, 45
platform_y_l2: .word 20, 15
...
restore_health:
	li $t1, 0x00ff00
	lw $t2, health		# load health
	beq $t2, 3, clear_water 		# no damage drawn
	beq $t2, 2, recover_level1	# level 1 damage
	beq $t2, 1, recover_level2	# level 2 damage
